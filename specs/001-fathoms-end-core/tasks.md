...
- [X] T039 [P] [US2] Crear componentes de mapa: `IslandNode.vue` (nodo de isla con nombre, tipo, estado seleccionable), `MapCanvas.vue` (grid/layout de 3 opciones de isla con efectos de hover y selección) en `src/components/map/`
